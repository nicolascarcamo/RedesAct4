...
# test 1
buff_size = 16
full_message = connection_socketTCP.recv(buff_size, mode="selective_repeat")
...
# test 3
buff_size = 14
message_part_1 = connection_socketTCP.recv(buff_size, mode="selective_repeat")
message_part_2 = connection_socketTCP.recv(buff_size, mode="selective_repeat")
